					...
					<div class="login-form">
						<form action="#" method="post">
							  <ul>
								...
								<li class="dat">
                                    <asp:Calendar class="date" type="text" value="dd-mm-yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'dd-mm-yyyy';}" ID="Calendar1" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" Width="200px" OnSelectionChanged="Calendar1_SelectionChanged">
								...
								<li class="selec">
                                    <asp:DropDownList ID="timeList" class="currentTime time-dropdown form-dropdown validate[required, limitDate]" runat="server" OnSelectedIndexChanged="timeList_SelectedIndexChanged" AutoPostBack="True">
							...
							<!---start-date-piker---->
							 ...
							 <ul>
							  ...
							  <ul>
								 ...
								 <li class="se">
                                     <asp:DropDownList class="time-dropdown form-dropdown validate[required, limitDate]" ID="types" runat="server" AutoPostBack="True" OnSelectedIndexChanged="types_SelectedIndexChanged"></asp:DropDownList> </li>
								 <div class="clear"></div>
								</ul> 							 
							  ...
							  <ul>
								 ...
								 <li class="se">
                                     <asp:DropDownList class="time-dropdown form-dropdown validate[required, limitDate]" ID="tablename" runat="server"></asp:DropDownList> </li>
								 <div class="clear"></div>
								</ul> 	
